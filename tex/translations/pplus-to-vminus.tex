...
\begin{align*}
    ...
    &\rightsquigarrow {\iffitt{\vexists{x}\; x = \etran{\expr};\; 
            \iffitt{\vexists{\btran{p_{1}}}\; \ptran{p_{1}}x\expr[1];\;
            []\; \dots []\; \vexists {\btran{p_{n}}}\; \ptran{p_{n}}x\expr[n]}}} \\
    &\rm{, $x$ fresh }
\end{align*}
...
\begin{align*}
    ...
    \vexists{y_{1} \dots y_{n}}\; &\ptran{p_{1}}y_{1}\; o\; \dots o\; \ptran{p_{n}}y_{n}\; o\;
    x = K y_{1} \dots y_{n}, \\
    &\rm{$\forall i.\; 1 \leq i \leq n:\; y_{i}$ fresh} \\
