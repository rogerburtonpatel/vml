...
%     {\ }
%     {{\textsc{Verse-If} (\texttt{($\vexists{x}\; x = v$)} e\; e)}  \rightarrowtail e{\{x \longmapsto v\}}
%     }
% \end{mathpar}
...
%     {{\textsc{Verse-If} (\texttt{($\vexists{x}\; x = v$)}\; e\; e)}  \rightarrowtail {\{x \longmapsto v\}}
%     }
%       {{\textsc{case}(x, v, e)}
