...
\subsection{Expressions}
    ...
    \newcommand\GNoTree{\vctx[Expr=g] \rightsquigarrow \uppsidown} 
...
\[
\inferrule*[Left=\textsc{ (Eval-Move-Eqn) }]
    {\inferrule*[] {}
    {
    \veval{e}{\valpha}
    \and 
...
%     1 \leq i \leq n
%     }}
%     {\veval{\lambda \vartheta_{1}, \dots \vartheta_{i}. e }{K(\vartheta_{1}, \dots \vartheta_{i})}}
% \]
...
% \mkevaljudgementcmd{GeCtxEqEval}{\vtuple{\rho, \`T', eq; g}}{v}
...
% \mkevaljudgementcmd{GeEqCtxEvalFail}{\vtuple{\rho, eq \cdot \T, g}}{\fail}
% \mkevaljudgementcmd{GeCtxEqEvalFail}{\vtuple{\rho, \T, eq; g}}{\fail}
...
% \mkevaljudgementcmd{GeExpSucc}{\vtuple{\rho, \T, e; g}}{v}
% \mkevaljudgementcmd{GeExpFail}{\vtuple{\rho, \T, e; g}}{\fail}
