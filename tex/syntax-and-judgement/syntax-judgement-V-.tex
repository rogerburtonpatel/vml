...
\subsection{Equations}
    ...
    \mkjudgementcmd{CtxToRho}{\vtuple{\rho, \vtempstuck \cons%
...
\mkevaljudgementcmd{GeEqCtxEval}{\vtuple{\rho, eq \cons \vtempstucks, ge}}{v}
...
\mkevaljudgementcmd{GeEqCtxEvalFail}{\vtuple{\rho, eq \cons \vtempstucks, ge}}{\vfail}
