...
\subsection{Expressions}
    ...
    \newcommand\EvalE{\vctx[Expr=\alpha] \Downarrow \vbar}
...
\inferrule*[Left=\textsc{ (Eval-ArrowExpr) }]
    {\vctx[Tempstucks=\emptyseq] \Downarrow \vbar}
...
\inferrule*[Left=\textsc{ (Vcon-Multi) }]
    ...
    {\veval{K(e_{1}, \dots e_{n})}{K(\vbar_{1}, \dots \vbar_{i})}}
\]
...
%     1 \leq i \leq n
%     }}
%     {\veval{\lambda \vbar_{1}, \dots \vbar_{i}. e }{K(\vbar_{1}, \dots \vbar_{i})}}
% \]
