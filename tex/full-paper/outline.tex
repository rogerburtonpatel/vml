...
\VMinus, a core language that uses Verse's equations with some restrictions, can
be compiled to a decision tree. \VMinus\ also subsumes \PPlus, a core language
with three popular extensions to pattern matching. 
  \end{abstract}
