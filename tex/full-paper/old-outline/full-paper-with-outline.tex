...
Then languages 
\3 Pattern matching is established and nice, verse is expressive. Compromise? 
\3 Say: But Verse has an unpredictable cost model. 
\2 Pattern matching 
Subject: Pattern matching. 

\3 Pattern matching dominate observers. Let's compare pattern matching with a
...
\2 Equations 
Subject: Equations. 
\3 Equations dominate observers. Let's compare pattern matching with a
straightforward way to examine and deconstruct data: observers. 

\2 Verse is expensive 
\2 Call for compromise 
\1 Chapter 2: Simplification for study and synthesis 
\2 \PPlus 
\2 \VMinus 
\2 Syntax, semantics 
\1 Chapter 3: \VMinus can be compiled to decision trees 
\2 D, decision trees, we are consistent 
\2 Translation, proof: \VMinus to \D
\1 Chapter 4: \VMinus subsumes patterns 
\2 Translation, proof: \PPlus to \VMinus
\1 Chapter 5: Rest. 
\end{outline}
...
\begin{outline}[enumerate]
    ...
    \1 \bf{Examples of Decision Trees - From Maranget. }
    \1 For our compilation, we introduce \D, a language of decision trees. 
    \1 \bf{Definition of \D}
    \2 \bf{Indeed, we are consistent with Maranget }
    \1 \bf{D is a simple generalization of Maranget, et al. }
...
\begin{outline}[enumerate]
    ...
    \1 \bf{Claim: Translation \PPlus\ -> \D\ is consistent with Maranget and others}
\end{outline}
